...
int main(char argc, char* argv[])
{
	...
	try
	{
		...
		{
		case upnp_natt::UPNPNATT_OK:
			if (out.protocol == upnp_natt::UDP_PORTMAP)
				protocolStr = "UDP";
			else if (out.protocol == upnp_natt::TCP_PORTMAP)
				protocolStr = "TCP";

			std::cout << "RemoteHost: " << out.remoteHost << std::endl
				<< "ExternalPort: " << out.externalPort << std::endl
				<< "PortMappingProtocol: " << protocolStr << std::endl
		...
		case upnp_natt::UPNPNATT_COM_ERROR:
			...
			break;
		case upnp_natt::UPNPNATT_UPNP_DEVICE_ERROR:
			std::cout << "getSpecificPortMappingEntry Failed: UPnP Device Error: " << std::dec << firstdevice.getLastUPnPDeviceError() << std::endl;
			firstdevice.clearLastUPnPDeviceError();
			break;
		default:
		...
		case upnp_natt::UPNPNATT_COM_ERROR:
			...
			break;
		case upnp_natt::UPNPNATT_UPNP_DEVICE_ERROR:
			std::cout << "deletePortMapping Failed: UPnP Device Error: " << std::dec << firstdevice.getLastUPnPDeviceError() << std::endl;
			firstdevice.clearLastUPnPDeviceError();
			break;
		default:
